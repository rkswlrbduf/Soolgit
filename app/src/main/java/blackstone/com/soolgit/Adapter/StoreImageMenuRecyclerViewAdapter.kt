...
class StoreImageMenuRecyclerViewAdapter(val context: Context, val list: ArrayList<StoreNoImageMenuData>?) : BaseQuickAdapter<StoreNoImageMenuData, BaseViewHolder>(R.layout.store_menu_recyclerview_row, list) {
