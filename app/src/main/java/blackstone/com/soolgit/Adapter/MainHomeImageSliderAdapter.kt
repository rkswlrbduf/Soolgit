...
class MainHomeImageSliderAdapter(private val context: Context, private val list: ArrayList<HotPlaceStoreData>?) : PagerAdapter() {
    ...
    fun updateList(list: ArrayList<HotPlaceStoreData>) {
        this.list?.clear()
